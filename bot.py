...
# الملفاتFILES = {
    # ================= ALGÈBRE =================    "Algèbre linéaire et applications": {        "Chapitre 1": "BQACAgQAAxkBAAOOaWuBmblWgyA53XWsBlQpoYvaVKkAApMrAAIDq2FTx1LXORVtlWs4BA",
...
    # ================= IA =================    "Historique et enjeux de l'IA": {        "Cours 1": "BQACAgQAAxkBAAIBt2lt4hHsQGSVX1tyvNOzK-ZHf2LHAAJZHAACaQNxU1RkY7kzA02IOAQ"    },
...
    # ================= ALGO =================    "Algorithmiques": {        "Cours 1": "BQACAgQAAxkBAAIBtWlt4HCByfV8M1I2tH8uLLgCcWbGAAJVHAACaQNxUxLAWmqhvNUBOAQ"    },
    # ================= PYTHON =================    "Programmation Python": {        "Cours 1": "BQACAgQAAxkBAAIBsmlt3qAX3Aw50-lh3UYFKBiYOsbfAAJMHAACaQNxU6fMj19Takg6OAQ",        "Cours 2": "BQACAgQAAxkBAAIBsWlt3p4hIw8b1Oe8Z8BXHCnk9CKFAAJLHAACaQNxU9vV-K1nmUmPOAQ"    },
    # ================= ANGLAIS =================    "Anglais": {        "Niveau A1": "BQACAgQAAxkBAAIB3Wlt-JpxXq1VSepO0oBhCGOmqZzkAAJ-HAACaQNxU6Lp1d68aCGfOAQ",        "Niveau A2": "BQACAgQAAxkBAAIB3Glt-GKd7qRSgESVktNdLzDee9KfAAJ9HAACaQNxU9lxQz5NH_IHOAQ"    }}
...
# اختيار المادةasync def choose_subject(update: Update, context: ContextTypes.DEFAULT_TYPE):    query = update.callback_query    await query.answer()
    subject = query.data
...
# إرسال الملفasync def send_file(update: Update, context: ContextTypes.DEFAULT_TYPE):    query = update.callback_query    await query.answer()
    subject, lesson = query.data.split("|")    file_id = FILES[subject][lesson]
    await query.message.reply_document(file_id)
# تشغيل البوتapp = ApplicationBuilder().token(TOKEN).build()
